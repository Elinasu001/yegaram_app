...
DelfinoConfig.cg.VPCGClientConfig = {
    ...
    //displayProviders: 'delfino,toss,naver2,kakaotalk,kakao,pass,payco,dream,kb,shinhan,hanaonesign,nh,fincert,fincertcorp',
	displayProviders: 'kakao,toss,naver2,fincert', 
    //displayProviders: 'delfino,kakao,toss,naver2,fincert', //'delfino,kakaotalk,toss,naver2,fincert',

	// multiSign 사용시 표시할 provider 목록, 설정하지 않으면 displayProviders목록 그대로 사용
    multiSignProviders: 'kakao,toss,naver2,fincert',
	
	// mdSign 사용시 표시할 provider 목록, 설정하지 않으면 displayProviders목록 그대로 사용
    mdSignProviders: 'kakao,toss,naver2,fincert',

	// mdMultiSign 사용시 표시할 provider 목록, 설정하지 않으면 displayProviders목록 그대로 사용
    mdMultiSignProviders: 'kakao,toss,naver2,fincert',
    ...
    finCertOptions: {
        ...
        encryptedFinCertParams: 'fixuilzELPmx6gewy6IxL9EFI6UYo2fyuu66xUl1RF3FciVN1WZtn0MMO3mUsV9VODCmgtV5gn6GbW/0dLUaB2eyAp4XKfVKjqTrtlyKctXQ/ZNeqAe39TwEsTqcWogL',
        encryptedFinCertParams_test: 'DpnH6gdLNOmJMzfW02XB6kisFhjed2Al7GTRmhwb+wv1V6tb55W+eu89gdnsoAo1fhG9Okv203OMfa0W0DYz6fgQY6fILVd+Q6V5mMmS3uY+MKQEnQO4Yijhk7Uj76g2',
